	...
	<div class="container">
		<form method="POST">
			...
			<div class="text-center">
				<label class="blanco">Modifier le pseudo :
					<input type="text" name="pseudo2" class="form-control" placeholder="Change your username">
				</label>
			</div>
...
<?php include "../Back/modifierPseudoPOO.php"?>
</body>
</html>