	...
	<div class="container">
		<form method="POST">
			...
			<div class="text-center">
				<label class="blanco">Modifier la description :
					<input type="password" name="desc2" class="form-control" placeholder="Change your description">
				</label>
			</div>
...
<?php include "../Back/modifierDescPOO.php"?>
</body>
</html>