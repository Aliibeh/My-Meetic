	...
	<div class="container">
		<form method="POST">
			...
			<div class="text-center">
				<label class="blanco">Modifier le mot de passe :
					<input type="password" name="mdp2" class="form-control" placeholder="Change your password">
				</label>
			</div>
...
<?php include "../Back/modifierMDPPOO.php"?>
</body>
</html>